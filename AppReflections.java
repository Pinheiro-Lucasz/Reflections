                ...
                if (m.getName().startsWith("get")) {
                    ...
                    for (Class classesType : m.getParameterTypes()){
                        if (classesType.equals(String.class)){
                            System.out.println(m.invoke(prod1, "Lucas"));
                        }else if (classesType.equals(String.class)){
                            System.out.println(m.invoke(prod1, 12l));
                        }else {
                            System.out.println(m.invoke(prod1, 12d));
                     }
